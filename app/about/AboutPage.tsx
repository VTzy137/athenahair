...
export default function AboutPage() {
  const commitments = [
    {
      ...
      description:
        "Chất lượng cao cấp, độ bền lâu dài, sợi tóc tự nhiên đồng đều.",
      icon: ICONS.star,
    ...
    },
    {
      ...
      description:
        "Hỗ trợ cả khách lẻ lẫn đối tác B2B với mức giá tối ưu nhất thị trường.",
    ...
    },
    {
      title: "Hàng sẵn có",
      description:
        "Kho hàng phong phú, sẵn sàng đóng gói và giao hàng nhanh chóng.",
      icon: ICONS.handbag,
      badge: "Fast Shipping",
    },
    {
      title: "Hỗ trợ 24/7",
      description:
        "Tư vấn tận tâm, sẵn sàng giải đáp mọi thắc mắc của khách hàng mọi lúc.",
      icon: ICONS.chatDots,
    ...
    },
    {
      ...
      description:
        "Đội ngũ kinh nghiệm, đáp ứng hoàn hảo các đơn hàng gia công theo yêu cầu.",
  ...
  return (
    <main className="relative flex w-full flex-1 flex-col overflow-hidden bg-background text-foreground">
      ...
      {/* Hero Section */}
      <PageWrapper className="flex flex-col items-center pt-16 pb-12 text-center sm:pt-24 sm:pb-16">
        ...
        <p className="mt-6 max-w-3xl text-base leading-relaxed text-muted-foreground sm:text-lg">
          Athena Hair là đơn vị hàng đầu tại Hà Nội chuyên cấp nguồn tóc
          extensions chất lượng cao cho các thương hiệu và doanh nghiệp kinh
          doanh tóc tại Việt Nam và quốc tế.
        </p>
      ...
      {/* Commitments Section */}
      <PageWrapper className="w-full py-12 sm:py-16">
        <div className="text-center">
          <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">
            Chúng Tôi Cam Kết
          </h2>
          <p className="mt-2 text-sm text-muted-foreground sm:text-base">
            Tiêu chuẩn chất lượng vượt trội và dịch vụ tận tâm trong từng đơn
            hàng
          </p>
        </div>
      ...
      <PageWrapper className="w-full pt-8 pb-20">
        <div className="relative overflow-hidden rounded-3xl border border-pink-500/30 bg-gradient-to-br from-pink-500/10 via-rose-500/5 to-amber-500/10 p-8 sm:p-12">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <h2 className="text-2xl font-bold leading-tight sm:text-3xl md:text-4xl max-w-3xl">
              Athena Hair không chỉ là nhà cung cấp, mà là đối tác tin cậy giúp
              phát triển kinh doanh tóc extension của bạn.
            </h2>

            <p className="mt-4 max-w-2xl text-sm sm:text-base text-muted-foreground">
              Đồng hành cùng hàng trăm thương hiệu tóc chuyên nghiệp tại Việt
              Nam và toàn cầu.
            </p>
